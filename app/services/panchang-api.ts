...
const dinMahimaTemplates = [
  ...
  [
    "આજે હનુમાનજીની પૂજા કરવાથી શક્તિ અને સાહસ વધે છે.",
    "આજે ગાયત્રી મંત્રનો જાપ કરવો શુભ છે.",
    "આજે દાન-પુણ્ય કરવાથી વિશેષ ફળ મળે છે.",
  ],
  [
  ...
  [
    "આજે સરસ્વતી દેવીની પૂજા કરવાથી વિદ્યા અને જ્ઞાન વધે છે.",
    "આજે તુલસી પૂજન કરવાથી આરોગ્ય સારું રહે છે.",
    "આજે પિતૃઓને તર્પણ આપવું શુભ છે.",
  ],
  [
...
function getRandomTime(minHour: number, maxHour: number): string {
  ...
  return convertToGujaratiNumerals(
...
export async function fetchPanchangData(date?: Date): Promise<PanchangData> {
  ...
  const dinMahimaTemplate =
    dinMahimaTemplates[weekday % dinMahimaTemplates.length];
