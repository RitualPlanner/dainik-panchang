...
export function CalendarView() {
  ...
  function getFestivalInfo(date: Date): { festivalName?: string; festivalType?: "major" | "minor" } {
    const day = date.getDate().toString().padStart(2, "0")
    const month = (date.getMonth() + 1).toString().padStart(2, "0")
    const dateString = `${day}/${month}`
      ...
      <Card>
        <CardHeader className="pb-2">
          <div className="flex justify-between items-center">
            ...
            <CardTitle>
              {monthNames[language as keyof typeof monthNames][currentDate.getMonth()]}{" "}
              {language === "gu"
                ? convertToGujaratiNumerals(currentDate.getFullYear().toString())
            ...
            {calendarDays.map((day, index) => (
              ...
              >
                <div className="text-center">
                  {language === "gu" ? convertToGujaratiNumerals(day.date.getDate().toString()) : day.date.getDate()}
                </div>
          ...
          <CardContent className="space-y-2">
            {selectedDayData.festival && (
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge variant={selectedDayData.festival.type === "major" ? "default" : "outline"}>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                {selectedDayData.dinMahima.map((item: string, index: number) => (
