...
export function createShareableLink(formData: any, boldFields: string[]): string {
  ...
  const baseUrl =
    typeof window !== "undefined" ? `${window.location.origin}${window.location.pathname}` : "https://yourdomain.com"
